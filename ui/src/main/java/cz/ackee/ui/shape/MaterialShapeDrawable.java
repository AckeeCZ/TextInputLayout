...
import cz.ackee.ui.color.MaterialColors;
import cz.ackee.ui.elevation.ElevationOverlayProvider;
import cz.ackee.ui.shadow.ShadowRenderer;
...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
  ...
  private void prepareCanvasForShadow(@NonNull Canvas canvas) {
    ...
    if (VERSION.SDK_INT < VERSION_CODES.LOLLIPOP) {
      ...
      canvas.clipRect(canvasClipBounds, Op.REPLACE);
    }
  ...
  static final class MaterialShapeDrawableState extends ConstantState {
    ...
    @Nullable public Mode tintMode = Mode.SRC_IN;
